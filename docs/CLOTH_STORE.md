...
- Descriptions are magazine-style copy generated under editorial constraints (see
  [`prompts/catalogue_description_system.md`](catalogue_description_system.md)).
...
Regenerate refocus deliverables: see `final_selfies/README.md` (repository only)
and `bench/selfie_refocus/README.md` (repository only).
...
- `final_catalog/README.md` (repository only) — catalogue packaging
...
- `RECONSTRUCTION_PIPELINE.md` (repository only) — generation pipeline
